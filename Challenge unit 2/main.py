'''Implement  a class called Player that represents a cricket player.The Player class shoud have a
...
Batsman and Bowler class and call the paly() method for each object.'''
